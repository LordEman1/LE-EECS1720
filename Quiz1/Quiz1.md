...
7. the finished `art-work` must align with your `information`
   - [X] I used (enter your `windowWidth`) HERE: Line 13 on the JavaScript file `sketch.js`
   - [X] I used (enter your `windowHeight`) HERE: Line 13 on the JavaScript file `sketch.js`
   - [X] I had (enter your `anger`) HERE: Line 11 on the JavaScript file `index.html`
